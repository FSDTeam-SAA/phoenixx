...
export default function Navbar() {
  ...
  const filteredLogo = logo?.data?.find(
    (item) =>
      (isDarkMode && item.status === "dark") ||
      (!isDarkMode && item.status === "light")
  );
  ...
  useEffect(() => {
    ...
    posts.forEach((post) => {
      ...
      if (
        startsWithWord(post.author.userName, searchQuery) ||
  ...
  const items = [
    {
      ...
      label: (
        <Flex
          gap="small"
          align="center"
          className={`p-2 cursor-pointer ${isDarkMode ? "text-black" : ""}`}
        >
        ...
        {suggestions.length === 0 ? (
          ...
          suggestions.map((item, index) => (
            <div
              ...
              tabIndex={0}
              onClick={() =>
                handleSuggestionClick(item.type, item.userName, item.id)
              }
              onKeyDown={(e) => {
    ...
    >
      ...
      >
        <Input
          ...
          prefix={
            <SearchOutlined
              style={{ color: isDarkMode ? "#bbbbbb" : "#888888" }}
            />
          }
          style={{
            height: "100%",
      ...
      <div style={{ position: "relative" }}>
        ...
        >
          ...
          {!showMobileSearch && (
            <Flex
              align="center"
              gap={screens.xs ? "8px" : "middle"}
              style={{ height: "100%", flex: "0 0 auto" }}
            >
              {screens.md ? (
                <>
                  <div
                    className="bg-[#0000FF] text-white flex items-center gap-2 rounded-lg px-2 cursor-pointer "
                  ...
                  >
                    <Plus className={`${isDarkMode? ' text-white' :''} text-white h-5 w-5 `} />
                  ...
                  >
                    <Button
                      ...
                      icon={
                        isDarkMode ? (
                          <Image
                            className={`${isDarkMode ? 'dark:invert-100':''} w-[40px] h-[40px] object-cover text-white `}
                            src="/icon/notification-removebg-preview.png"
                            alt="notification"
                            width={40}
                            height={40}
                          />
                          ...
                          <Image
                            className="bg-transparent w-[40px] h-[40px] object-cover text-white"
                            src="/icon/notification-removebg-preview.png"
                            alt="notification"
                            width={40}
                            height={40}
